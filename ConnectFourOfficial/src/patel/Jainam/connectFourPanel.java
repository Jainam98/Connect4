...
/**
 * Connect4 class runs all the buttons and makes them work to select various menu such as to start the game, 
 * for instructions, and to exit the game.
 * Connect4 also runs the game connect 4 between two players or one player(AI)
 * Winner is decided when four checkers gets into a row 
 */
...
public class connectFourPanel extends JPanel { 
  ...
  /**
   * onePlayerButtonListener allows a person to play against AI
   * AI: Basically plays automatically against the player 
   * @author yash,Jainam 
   *
   */
  ...
  /**
   * twoPlayerButtonListener allows two players to play connect four against each other
   * Whoever get four checkers in a row wins 
   * @author yash, Jainam 
   *
   */
  ...
  /**
   * playButtonListener allows to start the game and provide two different type of modes 
   * @author Yash, Jainam
   *
   */
  ...
  /**
   * goBackButtonListener allows to go back to the main menu 
   * @author Yash, Jainam
   *
   */
  ...
  /**
   * CloseListener allows to exit the game when clicked on quit button
   * @author Yash, Jainam
   *
   */
  ...
  /**
   * helpListener shows the rules of the game when help button is used
   * @author Yash, Jainam
   *
   */
    ...
    public void actionPerformed(ActionEvent event) {      
      ...
      if (event.getSource() == clickMeOne 
        ...
        if ( lastEmptyIdx != -1 ) {          
          ...
          if ( Win.IsWin(slots, playerColor, column, lastEmptyIdx)) {
        	...
        	JOptionPane.showMessageDialog(null, " Column is Full ", " No Slots Left ", JOptionPane.INFORMATION_MESSAGE);
        }
      } 
    }
